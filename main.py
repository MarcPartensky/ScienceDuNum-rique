...
class Main:
    ...
    def __call__(self, *args, **kwargs):
        ...
        self.L0 = getFloat(1, 10 ** 3, "10^-12 :") * 10 ** (-12)
    ...
    def ics(self):
        self.Ee = constants.electron_mass * (constants.c ** 2)
        self.lorentz=
        self.E0_E= self.lorentz * self.E0 (1- (self.v/constants.c) * math.cos(self.theta0))
        self.E1_L = self.E0_E / (1+ (self.E0_E/self.Ee) * (1 - math.cos(self.theta_E)))

        self.E1 = self.lorentz * self.E1_L (1 + (self.v/constants.c) * math.cos(self.theta1_E))
    ...
    def photoelectrique(self):
        ...
        while True:
            ...
            if result in element:
                break
            print("{} n'est pas dans la liste : ".format(result)+",".join(element.keys()))
        ...
        if self.W <= self.W0:
            ...
            print("Il y a émisison d'électrons")
